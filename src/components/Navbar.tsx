    ...
    >
      <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group">
          <Image src="/logo.png" alt="Shatabhisha" width={40} height={40} className={`rounded-full transition-all duration-300 group-hover:rotate-12 ${scrolled ? "brightness-0" : "brightness-0 invert"}`} />
